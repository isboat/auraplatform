...
export const api = {
  ...
  register: (name: string, email: string, password: string, phone?: string) => request<MessageResponse>('/auth/register', { method: 'POST', body: JSON.stringify({ name, email, password, phone: phone || null }) }),

...
public sealed class TokenService(IConfiguration configuration) : ITokenService
{
    ...
    {
        var claims = new[] { new Claim(JwtRegisteredClaimNames.Sub, user.Id!), new Claim(ClaimTypes.Name, user.Name), new Claim(ClaimTypes.Email, user.Email), new Claim(ClaimTypes.Role, user.IsAdministrator ? "Admin" : "User") };
